...
data_filename = 'exp1300'; % exp100, exp200, exp300, ... exp1000
typeClassifier = 'standardSVM'; % standardSVM or timeSeriesSVM

standaloneSVMdetector_switch = 0; % Switch to use ZUPT-SVM
svm_SHOEdetector_switch = 0; % Swtich to use ZUPT-SVM-SHOE
...
% loadedData = load([data_filename '_SVM_HD400.mat']); % For Journal Paper time series SVM clf
% loadedData = load([data_filename '_SVM.mat']);  % For Journal Paper simple SVM clf
% svm_results = loadedData.([data_filename '_SVM']); % For Journal Paper line of codes
