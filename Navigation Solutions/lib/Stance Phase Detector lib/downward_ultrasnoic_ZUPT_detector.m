...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [zupt,total,total_x,total_y,total_z,total_shoe] = downward_ultrasnoic_ZUPT_detector(u,shoe_height)
...
% total_shoe = mean(shoe_height);
total_shoe = shoe_height(end);
% total =total_shoe;


if total_shoe < simdata.factorShoeHeight
