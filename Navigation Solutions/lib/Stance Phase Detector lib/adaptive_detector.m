function [zupt,LR,thre2] = adaptive_detector(u, xi, dt, ZUPT, thre1, shock)
% -------------------------------------------------------------------------
...
%     p = [0.032 7.9276];  % Adjusted according to differnet subjects
    p = [0.03 4.0576];  % Adjusted according to differnet subjects
...
%     thre2 = alpha + theta*temp*log(dt/0.005) - beta*xi;
    thre2 = alpha + theta*temp*log(dt/0.1) - beta*xi;
