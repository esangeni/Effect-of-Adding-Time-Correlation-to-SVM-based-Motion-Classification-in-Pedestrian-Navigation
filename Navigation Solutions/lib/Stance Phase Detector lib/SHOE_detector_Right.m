function [zupt,total,total_x,total_y,total_z] = SHOE_detector_Right(u)
% -------------------------------------------------------------------------
...
[r, c] = size(u);
W=simdata_Right.Window_size;
sigma2_a = (simdata_Right.sigma_a/simdata_Right.Ts)^2;
sigma2_g = (simdata_Right.sigma_g/simdata_Right.Ts)^2;
g = 9.796;
u_n = mean(u(1:3, :), 2);
...
if(total < simdata_Right.factor)
    zupt = ones(1, simdata_Right.Window_size);
else
    zupt = zeros(1, simdata_Right.Window_size);
end
end
