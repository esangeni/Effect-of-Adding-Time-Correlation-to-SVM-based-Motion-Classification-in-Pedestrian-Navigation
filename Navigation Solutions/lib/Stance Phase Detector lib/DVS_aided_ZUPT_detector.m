...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [zupt,total,total_x,total_y,total_z,total_DVS] = DVS_aided_ZUPT_detector(u,fire_rate)
...
% total_DVS = log(mean(fire_rate)+1)/sigma2_DVS;
% total_DVS = (mean(fire_rate))^5/sigma2_DVS;
total_DVS = (mean((fire_rate-min_fire_DVS).^2))/sigma2_DVS;

total = total + total_DVS;

total = total/7;

if(total < simdata.factorDVS)
